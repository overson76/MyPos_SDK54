...
export const FEATURE_FLAGS = [
  ...
  },
  {
    ...
    default: false,
    help:
      '주문확정·조리완료 등의 알림음/음성을 다른 기기에서도 동시에 재생. ' +
      '소리가 날 때마다 클라우드에 1건씩 쓰고 기기 수만큼 읽기가 발생해 무료 한도를 ' +
      '빠르게 갉아먹습니다(2026-09-11 한도 소진 사고 후 기본 꺼짐). ' +
      '꺼도 소리를 낸 기기에서는 정상 재생되고, 주문·결제는 영향 없습니다.',
  },
  {
    key: 'aiRecommend',
    label: 'AI 메뉴 추천',
